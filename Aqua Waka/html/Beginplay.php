...
<head>
    ...
    $(document).ready(function() {
        ...
        localStorage.setItem('musica', 'verdadero');
    ...
    function stop2(){
        ...
        if (musicastop == 'verdadero')
        {
            ...
            localStorage.setItem('musica', 'falso');
        }
    }
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                <a href="OnePlayer.php"><input type="image" id="btnPlayGame" name="btnPG" src="../sources/btnplay.png" alt="Play"></a>
            </div>
        </div>
        <div class="row">
            <div class="col">
                <a href="MultiPlayer.php"><input type="image" id="btnMultip" name="btnMP" src="../sources/btnMultiplayer.png" alt="Players" onmouseover="document.getElementById('bubble').play()"></a>
            ...
            <div class="modal-content" style="background-color: rgba(0,0,0,.0001) !important; border: rgba(0,0,0,.0001) !important;">
                <div class="mBody modal-body">
                    ...
                    <div class="filabotones2 row justify-content-center">
                        <div class="col ">
                            <input type="image" class="img-fluid" id="btnAccept2" name="btnAS2" src="../sources/accept.png" alt="ok" onclick="play2()">
                        </div>
                        <div class="col ">
                            <input type="image" class="img-fluid" id="btnCancel2" name="btnCS2" src="../sources/cancel.png" alt="ok" onclick="stop2()">
                        </div>
                    </div>
                </div>
